...
public class RequestApi {
    public CurrencyRateModel sendRequest() {
    ...
    private CurrencyRateModel streamReader(InputStream stream) {
        ...
        return new Gson().fromJson(stringBuilder.toString(), CurrencyRateModel.class);
    }
}
